...
public class EntityIDDisplay extends UIComponent {
  ...
  public void draw(SpriteBatch batch)  {
    ...
    boolean value;
    if (isDebug == 0) value = false;
    else if (isDebug == 1) value = true;
    else value = false;
    debug.setVisible(true); //turn this to false if don't want debug infromation
