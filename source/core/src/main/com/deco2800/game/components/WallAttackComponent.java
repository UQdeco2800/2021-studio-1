 ...
 */
public class WallAttackComponent extends Component {
     ...
     */
    public WallAttackComponent(short targetLayer) {
     ...
     */
    public WallAttackComponent(short targetLayer, float knockback) {
        this.targetLayer = targetLayer;
    ...
    private void onCollisionStart(Fixture me, Fixture other) {
        ...
        target.getComponent(ColliderComponent.class).setLayer(PhysicsLayer.NONE);
