...
public class PowerUpGUIComponent2 extends UIComponent {
    private static final String LIGHTNING_1 = "images/PowerUpGUI/lightning1.png";
    ...
    private final Image lightning1 = new Image(ServiceLocator.getResourceService().getAsset(LIGHTNING_1, Texture.class));

    //place holder icons that will never be set to visible
    private final Image lightning2 = new Image(ServiceLocator.getResourceService().getAsset(LIGHTNING_1, Texture.class));
    private final Image lightning3 = new Image(ServiceLocator.getResourceService().getAsset(LIGHTNING_1, Texture.class));
