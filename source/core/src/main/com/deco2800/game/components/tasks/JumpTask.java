...
public class JumpTask extends DefaultTask implements PriorityTask {
  ...
  private final Vector2 jumpRange;
  ...
  /**
   * @param jumpRange Distance in X and Y the entity can move from its position when
   *          start() is
   *     called.
   * @param waitTime How long in seconds to wait between wandering.
   */
  public JumpTask(Vector2 jumpRange, float waitTime) {
  ...
  private Vector2 getRandomPosInRange() {
    Vector2 halfRange = jumpRange.cpy().scl(0.5f);
