...
public class NPCFactory {
        ...
        public static Entity createSkeleton(Entity target) {
                ...
                skeleton
                                ...
                                .addComponent(animator).addComponent(new GhostAnimationController());
        ...
        public static Entity createWallOfDeath(Entity target) {
                ...
                AnimationRenderComponent animator = new AnimationRenderComponent(
                                ServiceLocator.getResourceService().getAsset("images/wall.atlas", TextureAtlas.class));
                animator.addAnimation("walk", 0.1f, Animation.PlayMode.LOOP);

                wallOfDeath.addComponent(new CombatStatsComponent(config.health, config.baseAttack))
                                .addComponent(animator).addComponent(new DeathGiantAnimationController())
        ...
        private static Entity createBaseNPC(Entity target) {
                AITaskComponent aiComponent = new AITaskComponent().addTask(new WanderTask(new Vector2(10f, 0f), 5f));
                // .addTask(new MoveLeftTask());
                // .addTask(new AttackTask(new Vector2(10f, 0f), 5f));
                // .addTask(new ChaseTask(target, 10, 3f, 4f));
                Entity npc = new Entity().addComponent(new PhysicsComponent())
                                .addComponent(new PhysicsMovementComponent()).addComponent(new ColliderComponent())
