...
public class PlayerFactory {
  ...
  public static Entity createPlayer() {
    ...
    animator.addAnimation("throwing-spear-left", 0.05f,
            Animation.PlayMode.NORMAL);
    animator.addAnimation("throwing-while-jumping-spear-right", 0.05f,
            Animation.PlayMode.NORMAL);
    animator.addAnimation("throwing-while-jumping-spear-left", 0.05f,
            Animation.PlayMode.NORMAL);
    animator.addAnimation("throwing-spear-with-shield-right", 0.05f,
            Animation.PlayMode.NORMAL);
    animator.addAnimation("throwing-spear-with-shield-left", 0.05f,
            Animation.PlayMode.NORMAL);
    animator.addAnimation("throwing-spear-while-jumping-with-shield-right", 0.05f,
            Animation.PlayMode.NORMAL);
    animator.addAnimation("throwing-spear-while-jumping-with-shield-left", 0.05f,
            Animation.PlayMode.NORMAL);
